...
export const NavBar = () => {
  return (
    <nav className='navbar__container'>
        <button type="button" className="btn btn-warning"><i className="bi bi-list"></i></button>
        ...
        <div className="navbar__container__user">
            ...
            <button  type="button" className="navbar__container__user--logout btn btn-warning"><i className="bi bi-door-open-fill"></i></button>
      </div>
    </nav>
  );
};
